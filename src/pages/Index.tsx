...
const Index = () => {
  ...
  const services = [
    { title: "Instalação de Chuveiro", icon: ShowerHead },
    { title: "Instalação e criação de Tomadas e Interruptores 110V/220V", icon: Plug },
    { title: "Instalação de Ventilador de Teto", icon: Fan },
    { title: "Identificação de Curto-Circuito", icon: CircuitBoard },
    { title: "Solução para Queda de Energia", icon: LightbulbOff },
    { title: "Conversão de Voltagem", icon: Zap },
    { title: "Instalação de Interfones e Campainhas", icon: BellRing },
    { title: "Reparo de Falhas Elétricas", icon: ZapOff },
    { title: "Instalação de Aterramento Elétrico", icon: CheckCircle },
    { title: "Instalação de Luminária/Lustre", icon: LampCeiling },
    { title: "Revisão da Fiação Elétrica", icon: Cable}
  ];
